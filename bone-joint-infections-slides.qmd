...
## Chronic infectious arthritis: Tuberculosis (Pott's Disease)
...
## Imaging: X-ray, MRI, advanced modalities {.smaller}

<br>

::::: columns
::: {.column width="50%"}
-   **X-ray:** First study, Acute findings: soft tissue swelling, periosteal reaction (2 weeks)
...
-   **Advanced Imaging** - **CT:** Cortical detail, sequestra, bone destruction; useful when MRI unavailable
...
## Microbiologic diagnosis: Bone biopsy gold standard {.smaller}
...
![](bone-joint-infections-images/OVIVA.png)
